...
export default function WhatsAppWidget({
  ...
  const whatsappUrl = `https://wa.me/85218399216276?text=${encodeURIComponent(
    dict.defaultMessage
  )}`;
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
        ...
        >
          <div className="flex items-center gap-3 mb-4 pb-4 border-b border-gray-100">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-semibold text-gray-900 text-sm">{dict.popupTitle}</h3>
              <p className="text-xs text-[#25D366] font-medium">{dict.popupSubtitle}</p>
            </div>
            <button
          ...
          <p className="text-sm text-gray-600 mb-4 leading-relaxed">{dict.popupDescription}</p>
          <a
            href={whatsappUrl}
            target="_blank"
      ...
      <button
        ...
        style={{ animation: "breathe 2.5s ease-in-out infinite", boxShadow: "0 4px 20px rgba(37, 211, 102, 0.4)" }}
        aria-label="WhatsApp"
      >
