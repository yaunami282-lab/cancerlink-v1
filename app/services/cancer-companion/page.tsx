    ...
    <>
      ...
      <section className="py-16 bg-[#f7fbf7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {s.pillars.map((item: { icon: string; title: string; desc: string }) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {s.teamMembers.map((item: { icon: string; title: string; desc: string }) => (
      ...
      <section className="py-16 bg-[#f7fbf7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {s.journeyStages.map((item: { icon: string; title: string; desc: string }, i: number) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            {s.suitabilityItems.map((text: string, i: number) => (
